...
class Chupim extends StatefulWidget {
  ...
  @override
  _ChupimState createState() => _ChupimState();
}
              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          ' Uma famosa dança da região centro-oeste do Brasil. O nome tem origem nos pássaros homônimo, pois seus dançarinos realizam movimentos que lembram as batidas de asas do mesmo. Por ser um tipo de dança originário do Paraguai, tem bastante influencias nas danças espanholas e utilizam-se castanholas para a composição do ritmo. Ela também é uma dança, com uma forte dose de desafio e provocações, muito corriqueira naquelas paragens. ',
                          style: TextStyle(color: Colors.black)),
                    ),
