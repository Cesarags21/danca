              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          'bumba meu boi é uma manifestação artística e popular do folclore brasileiro. É reconhecido como Patrimônio Cultural Imaterial da Humanidade, pela Organização das Nações Unidas para a Educação, a Ciência e a Cultura (Unesco), e como Patrimônio Cultural do Brasil, pelo Instituto do Patrimônio Histórico e Artístico Nacional (Iphan).',
                          style: TextStyle(color: Colors.black)),
                    ),
              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          'Historiadores estimam que a dança do bumba meu boi surgiu no século XVIII, na região Nordeste. Nesse período, o boi tinha uma importância significativa, fosse pela sua simbologia, de força e resistência, fosse por fatores econômicos, já que havia grandes criadores de gado e colonizadores que faziam uso de mão de obra escravizada.A história que envolve a dança do bumba meu boi está ligada à lenda de um casal de escravizados, chamados Pai Francisco e Mãe Catirina (ou Catarina). Catirina estava grávida e começou a ter desejos por língua de boi. Seu marido, para atender o desejo da esposa gestante, matou o boi mais bonito de seu senhor. Quando o dono da fazenda notou a morte do animal, convocou curandeiros e pajés para ressuscitá-lo. O boi voltou à vida, e toda comunidade o celebrou com uma grande festa. Francisco e Catirina receberam o perdão do dono do boi.',
                          style: TextStyle(color: Colors.black)),
                    ),
