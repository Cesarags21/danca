...
class Ciranda extends StatefulWidget {
  ...
  @override
  _CirandaState createState() => _CirandaState();
}
              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          'A ciranda é uma das danças mais tradicionais do Brasil, sendo muito popular no estado de Pernambuco.',
                          style: TextStyle(color: Colors.black)),
                    ),
              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          'Ciranda é uma dança especialmente querida na Ilha de Itamaracá, onde teria surgido segundo alguns historiadores que alegam que foi inspirada nos movimentos das ondas do mar. Porém a sua origem não é consenso e alguns pesquisadores a apontam como uma dança vinda de Portugal. Seu nome, segundo alguns pesquisadores, veio do vocábulo espanhol “zaranda” (um instrumento usado para peneirar farinha). No início, os participantes eram em sua maioria trabalhadores rurais, pescadores, operários, entre outros, e ela foi associada às camadas populares. Nas cirandas, todos são aceitos, independente de cor, sexo, posição econômica ou qualquer outra coisa. Não há limite de participantes, podendo sair e entrar qualquer um que queira participar da roda. Ao expandir-se pelo país, a ciranda foi associada, em outros estados, às crianças. No entanto, em Pernambuco ainda é considerada uma dança de roda para adultos. Musicalmente, são usados principalmente instrumentos  de percussão, como o zabumba, o tarol, o ganzá e a maraca. As cantigas muitas vezes são improvisadas pelo mestre, que acompanha os músicos no centro da roda, enquanto os demais integrantes dançam. A ciranda é um dos gêneros homenageados no espetáculo Roda Dança, uma celebração da cultura brasileira. O evento será gratuito, no sábado dia 09 de agosto, às 15h, na Esplanada da Cidade das Artes.',
                          style: TextStyle(color: Colors.black)),
                    ),
