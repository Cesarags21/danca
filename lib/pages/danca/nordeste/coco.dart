              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          'A origem do coco se dá na união da cultura negra com os povos indígenas no Brasil. Apesar de frequente no litoral, acredita-se que o coco surgiu no interior, provavelmente nos quilombo, a partir do ritmo originado da quebra dos cocos para a retirada da amêndoa, com sua dança e tradição musical cantada, tornou-se um modo privilegiado de transmissão e manutenção do conhecimento e da tradição popular.No entanto, devido à sua origem nas camadas oprimidas e marginalizadas da sociedade, o coco sempre sofreu a discriminação dos meios de comunicação das classes dominantes. Assim, a difusão e a manutenção do coco como expressão cultural deve-se unicamente à sua resistência. É enfrentando essas dificuldades que os mestres coquistas passam grande parte de suas vidas sem apoio, apesar de sua arte possuir grande valor histórico, que persiste através dos tempos.',
                          style: TextStyle(color: Colors.black)),
                    ),
              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text('Ele não possui vestimenta própria.',
                          style: TextStyle(color: Colors.black)),
                    ),
