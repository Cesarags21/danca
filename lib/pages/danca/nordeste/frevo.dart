...
class Frevo extends StatefulWidget {
  ...
  @override
  _FrevoState createState() => _FrevoState();
}
              ...
              child: ExpansionPanelList(
                ...
                children: [
                  ExpansionPanel(
                    ...
                    body: ListTile(
                      title: Text(
                          'O Frevo surgiu em Pernambuco, entre o fim do século XIX e o início do século XX, primeiramente como um ritmo carnavalesco, nascido dos maxixes, dobrados, polcas e marchinhas de carnaval. O frevo originalmente não tem letra, é só tocado por uma banda. Do ritmo mais rápido, das bandas de músicas marciais, surgiu a dança do frevo, nos desfiles antigos de carnaval, quando jogadores de capoeira abriam o caminho para os músicos passarem pela multidão. O frevo mistura passos de ballet, capoeira e cossacos. O nome frevo tem origem na palavra ferver, que na pronúncia popular virou “frever”. O significado é o mesmo de fervura, ou seja, agitação, rebuliço. O termo foi usado pela primeira vez em 1908, em um jornal chamado Pequeno. Embora arraste multidões dançando e divertindo-se, o frevo é uma dança complexa, de passos complicados, muita improvisação, que misturam rodopios, gingados, passos miúdos, malabarismos entre outros. Os dançarinos utilizam ainda uma sombrinha colorida (aberta) enquanto dançam, demonstrando grande técnica. Existem mais de cem passos conhecidos do frevo, sendo os mais famosos: Locomotiva, Dobradiça, Fogareiro, Capoeira, Tesoura, Mola, Ferrolho e Parafuso, entre outros.',
                          style: TextStyle(color: Colors.black)),
                    ),
